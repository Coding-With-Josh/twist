...
export const Sidebar = () => {
  ...
  const colorUrlBig = () => {
    pathname === '/dashboard' || "/dashboard/discover" || "/dashboard/marketplace" || "/dashboard/analytics" || "/dashboard/analytics" || "/dashboard/monetization" ? 'bg-accent text-accent-foreground' : "";
};
  const colorUrlSmall = () => {
    pathname === '/dashboard' || "/dashboard/discover" || "/dashboard/marketplace" || "/dashboard/analytics" || "/dashboard/analytics" || "/dashboard/monetization" ? 'text-accent-foreground' : "";
};
